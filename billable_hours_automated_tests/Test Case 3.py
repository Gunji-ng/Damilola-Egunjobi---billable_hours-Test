# Automated test to verify that User should not be able to successfully parse timetable when any Project (Company) data is missing.
...
target_file_path = "/storage/emulated/0/Download/Missing_Project_data.csv"
